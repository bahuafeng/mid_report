...
% Add http://www.chinatex.org/bbs/forum.php?mod=viewthread&tid=1327
\makeatletter
\def\paragraph{\@startsection{paragraph}{4}{\z@}{-.1ex plus
        -0.1ex minus -.1ex}{0.1ex plus .1ex}{\hspace{1ex}\normalsize}}
        \makeatother
        \renewcommand\theparagraph{(\arabic{paragraph})\hspace{-1.5ex}}
...
\ifxueweidoctor
  ...
  \fancyhead[CE]{\songti \zihao{-5} 哈尔滨工业大学博士学位论文中期报告}%
  \fancyfoot[C]{\zihao{-5} -~\thepage~-}
	\renewcommand\bibsection{\section*{\centerline{\bibname}}
	\markboth{哈尔滨工业大学博士学位论文中期报告}{\bibname}}
\fi
\ifxueweimaster
  \fancyhead[C]{\songti \zihao{-5} 哈尔滨工业大学硕士学位论文中期报告}
  \fancyfoot[C]{\zihao{-5} -~\thepage~-}
	\renewcommand\bibsection{\section*{\centerline{\bibname}}
	\markboth{哈尔滨工业大学硕士学位论文中期报告}{\bibname}}
\fi
...
\def\makecover{
    ...
    \centerline{\kaishu\textbf{哈尔滨工业大学}}
		...
		\vspace{10mm}
		\centerline{\zihao{2}\songti\textbf{硕士学位论文中期报告}}
...
\vspace{30pt}
    ...
    \textbf{中期报告日期} & \rule[-4pt]{200pt}{1pt}\hspace{-326pt}\centerline{\textbf\@date}\\
    \end{tabular}
		\renewcommand{\arraystretch}{1}}
	\vfill
